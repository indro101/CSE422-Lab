...
# board = [[0, 5, 8, 2, 6, 2, 8, 8, 6],
#         [0, 8, 3, 1, 8, 2, 7, 5, 1],
#         [0, 6, 6, 3, 6, 6, 8, 8, 5],
#         [0, 3, 6, 2, 7, 1, 4, 8, 5]] #last one is perfect
print("set of boards")
for i in board:
    print(i)
...
while i != 0:  # runs on infinite loop till answer
    cou = cou + 1
    for j in board:
        calNpair(j)
